...
class Kluster():
    ...
    def kluster(self):
        ...
        kk_proc = Popen(
            ...
            ' -Log 0'
            ' -DistThresh 9.6'
            ' -UseFeatures ' + ''.join(map(
                str, self.feature_mask)), shell=True, stdout=PIPE)
