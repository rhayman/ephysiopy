...
class TrialInterface(FigureMaker, metaclass=abc.ABCMeta):
    ...
    def _get_map(self, cluster: int,
        ...
        Args:
            ...
            **kwargs:
                shuffle (bool): If True, the rate map will be shuffled by the default number of shuffles (100).
                                ...
                                length of the position data. The random amount is drawn from a uniform distribution. In order to preserve
        ...
        if kwargs.get("shuffle", False):
            ...
            time_shifts = r.integers(low=30 * self.PosCalcs.sample_rate,
                                     high=self.PosCalcs.npos,
                                     size=n_shuffles)
            weights = []
    ...
    def get_eb_map(self, cluster: int, channel: int, **kwargs):
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments for the function.
        """
        ego_map = self._get_map(cluster, channel, VariableToBin.EGO_BOUNDARY, **kwargs)
        return ego_map.rmap
    ...
    def get_speed_v_hd_map(self, cluster: int, channel: int, **kwargs):
        ...
        Args:
            ...
            **kwargs: Additional keyword arguments for the function.
        """
        return self._get_map(cluster, channel, VariableToBin.SPEED_DIR, **kwargs)
