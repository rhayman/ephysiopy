...
parser.add_argument(
    "-p", "--pos",
    action='store_true',
    help="Export position data")
parser.add_argument(
    "--postxt",
    action='store_true',
    help="Export pos data to txt file")
parser.add_argument(
    "-t", "--tetrodes",
    action='store_true',
    help="Export tetrode data")
parser.add_argument(
    "--eeg",
    action='store_true',
    help="Export LFP to an eeg file.")
parser.add_argument(
    "--egf",
    action='store_true',
    help="Export LFP to an egf file.")
parser.add_argument(
    "--ppm",
    type=int,
    default=300,
...
parser.add_argument(
    ...
    type=int,
    default=0,
    help="The LFP channel to export")
parser.add_argument(
    "-g", "--gain",
    type=int,
    default=6000,
    help="The gain applied to the LFP channel")
parser.add_argument(
    "-A", "--all",
    action='store_true',
...
parser.add_argument(
    ...
    nargs="+",
    default=['1', '2', '3', '4'],
    type=str, help="The tetrodes to use")
